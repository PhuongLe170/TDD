...
public class TicketPriceFeature : IClassFixture<ApiFactory>
{
    ...
    public TicketPriceFeature(ApiFactory factory)
    {
        _client = factory.CreateClient();
    }

    [Fact]
    public async Task Give_30min_ticket_When_1hour_has_price_2_Then_return_2()
    {
        ...
        var response = await _client.GetFromJsonAsync<TicketPriceResponse>(
